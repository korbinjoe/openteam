...
export const PHASE_STYLES: Record<AgentPhase, PhaseStyle> = {
  ...
  thinking: { color: 'rgb(var(--accent-running))', pulse: true },
  tool_running: { color: 'rgb(var(--accent-running))', pulse: true },
  responding: { color: 'rgb(var(--accent-running))', pulse: true },
